<?php
// Test script to verify opening hours validation by making actual HTTP requests to submit_reservations.php
echo "<h2>Testing Submit Reservations with New Opening Hours (using cURL)</h2>";
...
foreach ($testCases as $index => $test) {
    ...
    // Set cURL options
    curl_setopt($ch, CURLOPT_URL, 'http://localhost/haveli/submit_reservations.php');
